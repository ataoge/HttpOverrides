...
{
    public class AtaogeForwardedHeadersOptions
    {
        /// <summary>
        /// Use this header instead of <see cref="ForwardedHeadersDefaults.XForwardedForHeaderName"/>
        /// </summary>
        /// <seealso cref="Ataoge.AspNetCore.HttpOverrides.ForwardedHeadersDefaults"/>
        ...
        /// <summary>
        /// Use this header instead of <see cref="ForwardedHeadersDefaults.XForwardedPathHeaderName"/>
        /// </summary>
        /// <seealso cref="ForwardedHeadersDefaults"/>
        public string ForwardedPathHeaderName { get; set; } = ForwardedHeadersDefaults.XForwardedPathHeaderName;
        ...
        /// <summary>
        /// Use this header instead of <see cref="ForwardedHeadersDefaults.XOriginalPathHeaderName"/>
        /// </summary>
        /// <seealso cref="ForwardedHeadersDefaults"/>
        public string OriginalPathHeaderName { get; set; } = ForwardedHeadersDefaults.XOriginalPathHeaderName;
