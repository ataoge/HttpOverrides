...
namespace Ataoge.AspNetCore.HttpOverrides
{
    public class HttpMethodOverrideMiddleware
    {
        ...
        private readonly AtaogeHttpMethodOverrideOptions _options;

        public HttpMethodOverrideMiddleware(RequestDelegate next, IOptions<AtaogeHttpMethodOverrideOptions> options)
        {
            if (next == null)
            {
